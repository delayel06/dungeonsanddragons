...
public abstract class Personnage {
    ...
    //création d'un personnage avec des stats dépendant des lancés de dès
    public Personnage() {
    ...
    //création d'un modificateur d'attaque (Mod_Cha est le modificateur d'attaque de Cha)
    ...
    //permet de redefinir les stats du perso à chaque fois qu'il prend un objet boostant ses stats.
